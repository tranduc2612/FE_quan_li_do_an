...
import { assignTeacherMentor, autoTeacherMentor } from "~/services/projectApi";
...
function StudentManager({setCurrentPage}:IPageProps) {
    ...
    return ( 
        <>
                                                    ...
                                                    <div className='mx-5'>
                                                        ...
                                                        <div className="me-2" onClick={()=>{
                                                            if(formik.values.semester.length === 0){
                                                                toast.warn("Vui lòng chọn học kỳ !");
                                                                return
                                                            }
                                                            setLoading(true)
                                                                autoTeacherMentor({
                                                                ...
                                                                .then(item=>{
                                                                    if(item.success){
                                                                        toast.success("Tự động gán giảng viên hướng dẫn thành công")
                                                                        hanleFetchApiListStudent();
                                                                    }
                                                                })
                                                                .finally(()=>{
                                                                ...
                                                                <Button type="submit" variant="outlined" startIcon={<CalculateIcon />}>
                                                                    Tự đông gán giảng viên hướng dẫn
                                                                </Button>
                                                            </div>
                                                        <div>
            ...
            {loading && <div className="absolute w-full h-full top-0 left-0"><Loading /></div>}
        </>
    );
}
