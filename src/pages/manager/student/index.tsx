...
import { DataGrid, GridColDef, GridPaginationModel, GridValueGetterParams, viVN } from "@mui/x-data-grid";
...
function StudentManager({setCurrentPage}:IPageProps) {
    ...
    const [userSelect,setUserSelect] = useState<IStudent>({
        passwordText: "",
        userName: "",
        fullName: "",
        dob: new Date(),
    ...
    <div className="p-4 overflow-scroll max-h-screen">
           {
            ...
            {
                switchPageInput ? <RegisterStudent switchPageInput={switchPageInput} setSwitchPageInput={setSwitchPageInput} userSelect={userSelect} setUserSelect={setUserSelect} /> : 
                <div>
                    {/* Form tìm kiếm */}
                    {
                        loading ? <LoadingData /> : 
            ...
            {/* <ModalCustom 
                ...
                textConfirm="Xóa" 
                handleSave={hanleDeleteAccount} 
                handleClose={()=>{
                    setShowModalDelete(false);
                }}
                content={`Bạn có muốn xóa tài khoản ${userSelect.userName} ?`}
            /> */}
                    ...
                    <div className="p-5 rounded-xl bg-white w-2/4 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        ...
                        <div className={``}>
                            <div className="flex justify-center">
                                <span className="text-xl text-center font-medium">Bạn có muốn xóa sinh viên {userSelect.userName} ?</span>
                            </div>
                        </div>
